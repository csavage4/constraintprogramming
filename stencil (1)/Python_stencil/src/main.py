...
def main(args):
    ...
    if solution.is_solution:
        serialized_schedule = None #Serialize Schedule
        ...
        print(
            f'{{"Instance": "{filename}", "Time": {timer.getElapsed()}, "Result": {solution.n_fails}, "Solution": "{serialized_schedule}"}}'
        )
    else:
        print(
            f'{{"Instance": "{filename}", "Time": {timer.getElapsed()}, "Result": {solution.n_fails}"}}'
        )
